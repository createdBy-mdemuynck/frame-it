...
- Steps: upload files at 1MB, 10MB (exactly at limit), 11MB (over limit); assert 201, 201, 413 respectively; check error message for > limit.
- Updated limit: 10MB per file (changed from 5MB).
